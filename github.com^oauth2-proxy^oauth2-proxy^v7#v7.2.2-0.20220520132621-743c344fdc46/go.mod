module github.com/oauth2-proxy/oauth2-proxy/v7-v7.2.2-0.20220520132621-743c344fdc46

go 1.17

require github.com/oauth2-proxy/oauth2-proxy/v7 v7.2.2-0.20220520132621-743c344fdc46
